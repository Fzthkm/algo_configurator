...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/style-config_page.css') }}">
    <link rel="stylesheet" href="{{ asset('css/style-adaptive.css') }}">
    <script src="{{ asset('js/script.js') }}"></script>
    <script src="{{ asset('js/config_page.js') }}"></script>
</head>
...
<div class="container">
    <header>
        <div class="breadcrumb">
            <a href="{{ route('landing') }}" class="breadcrumb-item">Конфигуратор ПК</a>
        ...
        <section class="configurator">
            ...
            <div class="configurator-illustative-block">
                <div class="hint-text">
                    ...
                    <img src="{{ asset('assets/images/icons/config_page/question.svg') }}" />
                </div>
                <div class="illustative-block">
                    <div class="base-img">
                        <div class="case-block">
                            <img class="highlight-part part-case" src="{{ asset('assets/images/icons/config_page/case-constructor.svg') }}" />
                            <img class="added-part part-case" src="{{ asset('assets/images/icons/config_page/case_added.svg') }}" />

                            <button class="add-part-btn case-btn" data-category="{{ AllowedCategory::CHASSIS->value }}">
                                Корпус
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="motherboard-block">
                            <img class="highlight-part part-motherboard"
                                 src="{{ asset('assets/images/icons/config_page/motherboard_noadd.svg') }}" />
                            <img class="added-part part-motherboard"
                                 src="{{ asset('assets/images/icons/config_page/motherboard_added.svg') }}" />
                            <button class="add-part-btn motherboard-btn" data-category="{{ AllowedCategory::MOTHERBOARDS->value }}">
                                Материнская плата
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="videocard-block">
                            <img class="highlight-part part-videocard"
                                 src="{{ asset('assets/images/icons/config_page/videocard__noadd.svg') }}" />
                            <img class="added-part part-videocard" src="{{ asset('assets/images/icons/config_page/videocard__added.svg') }}" />
                            <button class="add-part-btn videocard-btn" data-category="{{ AllowedCategory::VIDEOCARD->value }}">
                                Видеокарта
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="cooler-block">
                            <img class="highlight-part part-cooler" src="{{ asset('assets/images/icons/config_page/cooler_noadd.svg') }}" />
                            <img class="added-part part-cooler" src="{{ asset('assets/images/icons/config_page/cooler_added.svg') }}" />

                            <button class="add-part-btn cooler-btn" data-category="{{ AllowedCategory::COOLERS->value }}">
                                Кулер
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="cpu-block">
                            <img class="highlight-part part-cpu" src="{{ asset('assets/images/icons/config_page/cpu_noadd.svg') }}" />
                            <img class="added-part part-cpu" src="{{ asset('assets/images/icons/config_page/cpu_added.svg') }}" />
                            <button class="add-part-btn cpu-btn" data-category="{{ AllowedCategory::CPU->value }}">
                                Процессор
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="powerunit-block">
                            <img class="highlight-part part-powerunit"
                                 src="{{ asset('assets/images/icons/config_page/powerunit_noadd.svg') }}" />
                            <img class="added-part part-powerunit" src="{{ asset('assets/images/icons/config_page/powerunit_added.svg') }}" />
                            <button class="add-part-btn powerunit-btn" data-category="{{ AllowedCategory::POWERSUPPLY->value }}">
                                Блок питания
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="ram-unit">
                            <img class="highlight-part part-ram" src="{{ asset('assets/images/icons/config_page/ram_noadd.svg') }}" />
                            <img class="added-part part-ram" src="{{ asset('assets/images/icons/config_page/ram_added.svg') }}" />
                            <button class="add-part-btn ram-btn" data-category="{{ AllowedCategory::RAM->value }}">
                                Оперативная память
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
                        <div class="ssd-block">
                            <img class="highlight-part part-ssd" src="{{ asset('assets/images/icons/config_page/ssd__noadd.svg') }}" />
                            <img class="added-part part-ssd" src="{{ asset('assets/images/icons/config_page/ssd_added.svg') }}" />
                            <button class="add-part-btn ssd-btn" data-category="{{ AllowedCategory::SSD->value }}">
                                SSD
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        ...
                        <div class="hhd-block">
                            <img class="highlight-part part-hdd" src="{{ asset('assets/images/icons/config_page/hdd_noadd.svg') }}" />
                            <img class="added-part part-hdd" src="{{ asset('assets/images/icons/config_page/hdd_added.svg') }}" />
                            <button class="add-part-btn hdd-btn" data-category="{{ AllowedCategory::HDD->value }}">
                                Жёский диск
                                <img src="{{ asset('assets/images/icons/config_page/plus.svg') }}" />
                            </button>
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const productContainer = document.getElementById("list-view");
        ...
        function logCurrentFilters() {
            ...
            const payload = { search, filters, saleOnly, sort };

            console.clear();
            console.log("Отправляемые данные на бэк:", payload);
            sendFilters(payload, type = 'cpu');
        }

        function sendFilters(payload, type) {

            const url = `/products/${type}?name=${payload.search}`;
        ...
        function renderProducts(products) {
            ...
            products.forEach(product => {
                ...
                card.className = "product-card list-style desktop-only";
                card.innerHTML = `
            <div class="product-card-img list-style">
              <div class="card-img-main-product list-style">
            ...
            <div class="info">
              <h3 class="product-title list-style">${product.title}</h3>
              <div class="more-data">
                <div class="product-code">Код товара: ${product.code}</div>
                <div class="details" id="details-btn">
                  <a href="#">
                    <span class="full-text">Смотреть подробнее</span>
                    <span class="short-text">Подробнее</span>
            ...
            <div class="cashflow-options list-style">
              <div class="buy-options">
                ...
                <div class="payment-options">
                  <div class="payment-option green">от <span>${product.installment}</span> руб/мес</div>
                  <div class="payment-desc">картой рассрочки <br> или в кредит</div>
                </div>
              </div>
              <div class="buttons-for-deal">
